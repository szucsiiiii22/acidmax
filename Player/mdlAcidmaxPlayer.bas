...
Private lAcidmaxPlayerForm As New frmMain
...
SetWindowText CLng(Trim(lParentHwnd)), "acidmax player"
Exit Sub
ErrHandler:
...
Public Sub InitAcidmaxPlayerForm()
On Local Error GoTo ErrHandler
Set lAcidmaxPlayerForm = New frmMain
ShowNonModalForm lAcidmaxPlayerForm
Exit Sub
ErrHandler:
    MsgBox Err.Description
    Err.Clear
