    ...
    public abstract class BaseClient : IDisposable
    {
        ...
        public TimeSpan KeepAliveInterval
        {
            ...
            set
            {
                ...
                if (value == TCMSSH.Session.InfiniteTimeSpan)
                {
        ...
        /// </summary>
        /// <example>
        ///   <code source="..\..\TCMSSH.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect ErrorOccurred" language="C#" title="Handle ErrorOccurred event" />
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///   <code source="..\..\TCMSSH.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect HostKeyReceived" language="C#" title="Handle HostKeyReceived event" />
        /// </example>
        ...
        internal BaseClient(ConnectionInfo connectionInfo, bool ownsConnectionInfo, IServiceFactory serviceFactory)
        {
            ...
            _keepAliveInterval = TCMSSH.Session.InfiniteTimeSpan;
        }
        ...
        {
            if (_keepAliveInterval == TCMSSH.Session.InfiniteTimeSpan)
                return;
