...
using TCMSSH.Channels;
using TCMSSH.Common;
using TCMSSH.Messages;
using TCMSSH.Messages.Connection;
using TCMSSH.Messages.Transport;
...
namespace TCMSSH
{
    ...
    public partial class SshCommand : IDisposable
    {
        ...
        /// </value>
        /// <example>
        ///     <code source="..\..\TCMSSH.Tests\Classes\SshCommandTest.cs" region="Example SshCommand CreateCommand Execute CommandTimeout" language="C#" title="Specify command execution timeout" />
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///     <code source="..\..\TCMSSH.Tests\Classes\SshCommandTest.cs" region="Example SshCommand RunCommand ExitStatus" language="C#" title="Get command execution exit status" />
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///     <code source="..\..\TCMSSH.Tests\Classes\SshCommandTest.cs" region="Example SshCommand CreateCommand Execute OutputStream" language="C#" title="Use OutputStream to get command execution output" />
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///     <code source="..\..\TCMSSH.Tests\Classes\SshCommandTest.cs" region="Example SshCommand CreateCommand Execute ExtendedOutputStream" language="C#" title="Use ExtendedOutputStream to get command debug execution output" />
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///     <code source="..\..\TCMSSH.Tests\Classes\SshCommandTest.cs" region="Example SshCommand CreateCommand Error" language="C#" title="Display command execution error" />
        /// </example>
        public string Error
        {
            get
        ...
        /// <exception cref="TCMSSH.Common.SshConnectionException">Client is not connected.</exception>
        /// <exception cref="TCMSSH.Common.SshOperationTimeoutException">Operation has timed out.</exception>
        ...
        /// <returns>Command execution result</returns>
        /// <example>
        ///     <code source="..\..\TCMSSH.Tests\Classes\SshCommandTest.cs" region="Example SshCommand CreateCommand Execute" language="C#" title="Simple command execution" />
        ///     <code source="..\..\TCMSSH.Tests\Classes\SshCommandTest.cs" region="Example SshCommand CreateCommand Error" language="C#" title="Display command execution error" />
        ///     <code source="..\..\TCMSSH.Tests\Classes\SshCommandTest.cs" region="Example SshCommand CreateCommand Execute CommandTimeout" language="C#" title="Specify command execution timeout" />
        /// </example>
        /// <exception cref="TCMSSH.Common.SshConnectionException">Client is not connected.</exception>
