...
using TCMSSH.Security.Cryptography.Ciphers.Modes;
using TCMSSH.Security.Cryptography.Ciphers;
...
namespace TCMSSH
{
    ...
    public class ConnectionInfo : IConnectionInfoInternal
    {
        ...
        /// </value>
        /// <example>
        ///   <code source="..\..\TCMSSH.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect Timeout" language="C#" title="Specify connection timeout" />
        /// </example>
