...
namespace TCMSSH
{
    ...
    public partial class SftpClient : BaseClient
    {
        ...
        /// </summary>
        /// <param name="path">The path.</param>
        /// <returns>Reference to <see cref="TCMSSH.Sftp.SftpFile"/> file object.</returns>
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="SftpPathNotFoundException"><paramref name="path"/> was not found on the remote host.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="path" /> is <b>null</b>.</exception>
        /// <exception cref="ObjectDisposedException">The method was called after the client was disposed.</exception>
        ...
        /// </summary>
        /// <param name="path">The path.</param>
        /// <returns>Reference to <see cref="TCMSSH.Sftp.SftpFileSytemInformation"/> object that contains file status information.</returns>
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="path" /> is <b>null</b>.</exception>
        /// <exception cref="ObjectDisposedException">The method was called after the client was disposed.</exception>
