...
dialog translate {
  ...
  link "www.team-nexgen.com", 16, 274 88 120 16
...
on *:dialog:translate:sclick:*: { 
  ...
  if ($did == 16) { run http://www.team-nexgen.com }
  if ($did == 17) { 
...
dialog weather {
  ...
  size -1 -1 318 288
  option pixels
  edit "", 3, 166 104 83 20, autohs
  button report, 4, 254 104 50 20, default
  button close, 17, 249 254 50 20, ok
  text "location", 1, 125 107 40 16
  radio "notice", 2, 15 142 56 20
  radio "query", 5, 73 143 53 20
  radio "channel", 9, 127 143 62 20
  check "public !weather trigger enable", 10, 8 192 186 20
  box "send via", 13, 7 126 186 42
  button advertise, 14, 214 218 77 20, disable
  edit "", 7, 46 104 76 21
  text "trigger", 8, 10 107 34 16
  check "kick/ban on flood", 11, 8 171 106 20
  list 12, 198 144 112 71, size vsbar
  check "advertise all channels", 15, 8 213 133 20
  text "select channel", 16, 215 127 73 15
  text "local command: /weather <location>", 18, 11 247 214 16
  text "public command: !weather <location>", 19, 11 263 214 16
  box "", 20, 5 238 227 45
