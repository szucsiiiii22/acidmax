...
set -nu1 %::pre 4.|.3
set -nu1 %::c1 03 | set -nu1 %::c2 04 | set -nu1 %::c3 03 | set -nu1 %::c4 02
...
if ($nick == $me) { %:echo 4.|.303 [04 $+ %::chan $+ 03] %:comments | haltdef }
...
%:echo 4.|.303 part: %::nick 03[04 $+ %::address $+ 03] [04 $+ %::text $+ 03] %:comments | haltdef
...
if ($nick == $me) { %:echo = echo $color(nick) -sti2 | %:echo 4.|.303 nick: %::newnick $+  %:comments }
  while (%i) {
    set -u1 %::chan $comchan($newnick, %i)
    %tgt = $gettok($hget(Kte_Events, %::chan), 7, 44)
if (%tgt != 2) || ($nick == $me) { %:echo = echo $color(nick) -ti2 %::chan | %:echo 4.|.303 nick: %::nick 03[04 $+ %::address $+ 03]03 is now %::newnick $+  %:comments }
    dec %i
  }
if ($query($newnick)) { unset %::chan | %:echo = echo $color(nick) -ti2 $newnick | %:echo 4.|.303 nick: %::nick 03[04 $+ %::address $+ 03]03 is now %::newnick $+  %:comments }
  haltdef
...
%:echo 4.|.303 usermode: %::modes $+  %:comments | haltdef
  unset %::modes
...
set -nu1 %::chan $chan
  ...
  set -nu1 %::modes $1-
%:echo 4.|.303 mode: %::nick 03[04 $+ %::address $+ 03] 03set: %::modes $+  %:comments | haltdef
  unset %::modes
unset %:echo %::nick %::address %::target %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick
}
...
set -nu1 %::chan $chan
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 4.|.303 %::nick sets topic: 03[04 $+ %::text $+ 03] %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on ^&*:KICK:#:{
  if ($chan !ischan) { return }
...
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
  if ($knick == $me) {
%:echo 4.|.303 You were kicked from %::chan by %::nick 03[04 $+ %::text $+ 03] %:comments
    if (%tgt == 2) { set -u1 %:echo echo $color(kick) -ti2 $chan }
    else { set -u1 %:echo echo $color(kick) -seti2 }
%:echo 4.|.303 You were kicked from %::chan by %::nick 03[04 $+ %::text $+ 03] %:comments
    _left $chan
  }
else { %:echo 4.|.303 kick: %::nick 03[04 $+ %::address $+ 03]03 kicked %::knick 03[04 $+ %::text $+ 03] %:comments }
  haltdef
...
%:echo 4.|.303 invite: %::nick 03[04 $+ %::address $+ 03]03 invites you to join %::chan $+  %:comments | haltdef
...
set -nu1 %::nick $nick
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 4.|.303 error: %::text $+  %:comments | haltdef
...
set -nu1 %::address $address
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 4.|.303 nick: %::nick 03[04 $+ %::address $+ 03] is on irc %:comments | haltdef
unset %:echo %::nick %::address %::parentext %::me %::server %::port %::pre %::c? %::text
}
on ^&*:UNOTIFY:{
  set -u1 %:echo echo $color(notify) -ti2 $+ $iif(($_isactive) && (@* !iswm $active), a, s)
...
set -nu1 %::address $address
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 4.|.303 nick: %::nick 03[04 $+ %::address $+ 03] is off irc %:comments | haltdef
unset %:echo %::nick %::address %::parentext %::me %::server %::port %::pre %::c? %::text
}
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 04!03 $+ %::nick $+ 04!03 %::text $+  %:comments | haltdef
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 04-03 $+ %::server $+ 04-03 %::text $+  %:comments | haltdef
...
%:echo 04[ $+ %::cmode $+ 03 $+ %::nick $+ 04]03 %::text $+  %:comments
  }
  else {
    set -u1 %::cnick $cnick($me).color
%:echo 04[03 $+ %::nick $+ 04]03 %::text $+  %:comments
  }
...
else { %:echo 04[03 $+ %::nick $+ 04]03 %::text $+  %:comments }
  }
  else {
    set -u1 %:echo echo $color(own) -ti2 $+ $_active
%:echo 04-> *03 $+ %::target $+ 04*03 %::text $+  %:comments | haltdef
  }
...
else { %:echo 04* 03 $+ %::me %::text $+  %:comments }
  }
...
if ($1 ischan) { set -u1 %::chan $1 | %:echo 04-> -03 $+ %::target $+ 04-03 %::text $+  %:comments }
else { %:echo 04•03• notice sent 04» 03( $+ %::nick $+ )0403 %::text $+  %:comments }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 04[ $+ %::cmode $+ 03 $+ %::nick $+ 04]03 %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on &^*:ACTION:*:#:{
  if ($chan !ischan) { return }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 04• 03 $+ %::nick %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on &^*:NOTICE:*:#:{
  if ($chan !ischan) { return }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 04-03 $+ %::nick $+ : $+ %::target $+ 04-03 %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
if ($query($nick)) { set -u1 %:echo %e $nick | %:echo 04* 03 $+ %::nick %::text $+  %:comments | haltdef }
  else {
    if ($window(Message Window)) { set -u1 %:echo %e $+ d }
    elseif ($_isactive) && (@* !iswm $active) && ($hget(Kte_Events, Active.Queries)) { set -u1 %:echo %e $+ a }
    else { set -u1 %:echo %e $+ s }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 04-03 $+ %::nick 04[03 $+ %::address $+ 04]-03 %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::text
}
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
if (%ch) { %:echo 04[03 $+ %::nick $+ : $+ %::chan %::ctcp $+ 04] 03 $+ %::text $+  %:comments }
else { %:echo 04[03 $+ %::nick %::ctcp $+ 04] 03 $+ %::text $+  %:comments }
...
if ($1 ischan) { set -u1 %::chan $1 | %:echo 04-> [03 $+ %::target %::ctcp $+ 04] 03 $+ %::text $+  %:comments }
else { set -u1 %::nick $1 | %:echo 04-> [03 $+ %::target %::ctcp $+ 04] 03 $+ %::text $+  %:comments }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 04[03 $+ %::nick %::ctcp reply04] 03 $+ %::text $+  %:comments | haltdef
...
set -nu1 %::c1 03 | set -nu1 %::c2 04 | set -nu1 %::c3 03 | set -nu1 %::c4 02
if (* iswm %::text) { set -nu1 %::parentext 2[4 $+ %::text $+ 2] }
%:echo 04-> [03 $+ %::target %::ctcp reply04] 03 $+ %::text $+  %:comments
...
alias -l kte::Echo %:echo 03 $+ %::text $+  %:comments
alias -l kte::EchoTarget %:echo 03 $+ %::text $+  %:comments
alias -l kte::Error %:echo 4.|.303error: %::text $+  %:comments
alias -l kte::Raw.303 %:echo 4.|.3 %::text are online %:comments
alias -l kte::RAW.375 %:echo 4.|.303MOTD - %::server $+  %:comments
alias -l kte::RAW.255 %:echo 4.|.303I have %::users clients and %::value servers %:comments
alias -l kte::RAW.471 %:echo 4.|.303error:  $+ %::chan $+  is full %:comments
alias -l kte::RAW.391 %:echo 4.|.303server time: %::text $+  %:comments
alias -l kte::Raw.332 %:echo 03.::03 topic: 03[04 $+ %::text $+ 03]03 %:comments
alias -l kte::RAW.372 %:echo 03 $+ %::text $+  %:comments
alias -l kte::RAW.252 %:echo $+(%::pre,,%::c1,%::value) $iif(%::value == 1,operator,operators) online
alias -l kte::Raw.408 %:echo 4.|.303error:  $+ %::chan $+  you cannot use colors on this channel %:comments
...
alias -l kte::RAW.265 %:echo 4.|.303Current local users: %::users max: %::value $+  %:comments
alias -l kte::RAW.253 %:echo 4.|.303 $+ %::value unknown connections %:comments
alias -l kte::RAW.001 %:echo 03Welcome %::text $+  %:comments
alias -l kte::RAW.482 %:echo 4.|.303error:  $+ %::chan $+  you aren't an op %:comments
alias -l kte::RAW.401 %:echo 4.|.303error:  $+ %::nick $+  no such nickname %:comments
alias -l kte::RAW.266 %:echo 4.|.303Current global users: %::users max: %::value $+  %:comments
alias -l kte::RAW.250 %:echo 4.|.303 $+ %::value total connections %:comments
alias -l kte::RAW.002 %:echo 03Your Host Is %::server $+ , running %::value $+  %:comments
alias -l kte::RAW.474 %:echo 4.|.303error:  $+ %::chan $+  banned from channel %:comments
alias -l kte::RAW.003 %:echo 03This server was created on %::value $+  %:comments
alias -l kte::Raw.251 %:echo 4.|.303There are %::users users online, %::text invisible, on %::value servers %:comments
alias -l kte::RAW.475 %:echo 4.|.303error:  $+ %::chan $+  key required %:comments
alias -l kte::RAW.324 %:echo 03.::03 modes: 03[04 $+ %::modes $+ 03]03 %:comments
alias -l kte::RAW.403 %:echo 4.|.303error:  $+ %::chan $+  no such channel %:comments
alias -l kte::RAW.376 %:echo 4.|.303end of MOTD %:comments
alias -l kte::RAW.221 %:echo 4.|.303 usermode: %::modes $+  %:comments
alias -l kte::Raw.301 %:echo 4.|.3 %::nick is away: %::text $+  %:comments
alias -l kte::RAW.432 %:echo 4.|.303error:  $+ %::nick $+  invalid nickname %:comments
alias -l kte::RAW.404 %:echo 4.|.303error:  $+ %::chan $+  unable to send message %:comments
alias -l kte::RAW.353 %:echo 03.::03 names 03[04 $+ %::chan $+ 03]:03 %::text $+  %:comments
alias -l kte::RAW.341 %:echo 4.|.303 $+ %::nick invited to %::chan $+  %:comments
alias -l kte::RAW.005 %:echo %::text $+  %:comments
alias -l kte::RAW.473 %:echo 4.|.303error:  $+ %::chan $+  invite only %:comments
alias -l kte::Raw.302 %:echo 4.|.303 userhost %::nick $+ : %::address $+  %:comments
alias -l kte::RAW.433 %:echo 4.|.303error:  $+ %::nick $+  is in use %:comments
alias -l kte::RAW.421 %:echo 4.|.303error:  $+ %::value $+  invalid command %:comments
alias -l kte::RAW.366 %:echo 03.::03 end of /names %::chan $+  %:comments
