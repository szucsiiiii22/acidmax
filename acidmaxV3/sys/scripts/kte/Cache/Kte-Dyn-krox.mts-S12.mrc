...
set -nu1 %::pre 07³14
set -nu1 %::c1 14 | set -nu1 %::c2 15 | set -nu1 %::c3 07 | set -nu1 %::c4 14
...
if ($nick == $me) { %:echo 07³1414 [15 $+ %::chan $+ 14] %:comments | haltdef }
...
if ($nick($chan, $nick).pnick != $nick) { set -nu1 %::cmode $left($ifmatch, 1) } | set -nu1 %::cnick $nick($chan, $nick).color
set -nu1 %::chan $chan
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 07³1414 part: %::nick 07[15 $+ %::address $+ 07] [15 $+ %::text $+ 07] %:comments | haltdef
...
if ($nick == $me) { %:echo = echo $color(nick) -sti2 | %:echo 07³1414 nick: %::newnick $+  %:comments }
  while (%i) {
    set -u1 %::chan $comchan($newnick, %i)
    %tgt = $gettok($hget(Kte_Events, %::chan), 7, 44)
if (%tgt != 2) || ($nick == $me) { %:echo = echo $color(nick) -ti2 %::chan | %:echo 07³1414 nick: %::nick 07[15 $+ %::address $+ 07]14 is now %::newnick $+  %:comments }
    dec %i
  }
if ($query($newnick)) { unset %::chan | %:echo = echo $color(nick) -ti2 $newnick | %:echo 07³1414 nick: %::nick 07[15 $+ %::address $+ 07]14 is now %::newnick $+  %:comments }
  haltdef
...
%:echo 07³1414 usermode: %::modes $+  %:comments | haltdef
  unset %::modes
...
set -nu1 %::chan $chan
  ...
  set -nu1 %::modes $1-
%:echo 07³1414 mode: %::nick 07[15 $+ %::address $+ 07] 14set: %::modes $+  %:comments | haltdef
  unset %::modes
unset %:echo %::nick %::address %::target %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick
}
...
set -nu1 %::chan $chan
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 07³1414 %::nick sets topic: 07[15 $+ %::text $+ 07] %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on ^&*:KICK:#:{
  if ($chan !ischan) { return }
...
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
  if ($knick == $me) {
%:echo 07³1414 You were kicked from %::chan by %::nick 07[15 $+ %::text $+ 07] %:comments
    if (%tgt == 2) { set -u1 %:echo echo $color(kick) -ti2 $chan }
    else { set -u1 %:echo echo $color(kick) -seti2 }
%:echo 07³1414 You were kicked from %::chan by %::nick 07[15 $+ %::text $+ 07] %:comments
    _left $chan
  }
else { %:echo 07³1414 kick: %::nick 07[15 $+ %::address $+ 07]14 kicked %::knick 07[15 $+ %::text $+ 07] %:comments }
  haltdef
...
%:echo 07³1414 invite: %::nick 07[15 $+ %::address $+ 07]14 invites you to join %::chan $+  %:comments | haltdef
...
set -nu1 %::nick $nick
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 07³1414 error: %::text $+  %:comments | haltdef
...
set -nu1 %::address $address
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 07³1414 nick: %::nick 07[15 $+ %::address $+ 07] is on irc %:comments | haltdef
unset %:echo %::nick %::address %::parentext %::me %::server %::port %::pre %::c? %::text
}
on ^&*:UNOTIFY:{
  set -u1 %:echo echo $color(notify) -ti2 $+ $iif(($_isactive) && (@* !iswm $active), a, s)
...
set -nu1 %::address $address
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 07³1414 nick: %::nick 07[15 $+ %::address $+ 07] is off irc %:comments | haltdef
unset %:echo %::nick %::address %::parentext %::me %::server %::port %::pre %::c? %::text
}
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 15!14 $+ %::nick $+ 15!14 %::text $+  %:comments | haltdef
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 15-14 $+ %::server $+ 15-14 %::text $+  %:comments | haltdef
...
%:echo 15[ $+ %::cmode $+ 14 $+ %::nick $+ 15]14 %::text $+  %:comments
  }
  else {
    set -u1 %::cnick $cnick($me).color
%:echo 15[14 $+ %::nick $+ 15]14 %::text $+  %:comments
  }
...
else { %:echo 15[14 $+ %::nick $+ 15]14 %::text $+  %:comments }
  }
  else {
    set -u1 %:echo echo $color(own) -ti2 $+ $_active
%:echo 15-> *14 $+ %::target $+ 15*14 %::text $+  %:comments | haltdef
  }
...
else { %:echo 15* 14 $+ %::me %::text $+  %:comments }
  }
...
if ($1 ischan) { set -u1 %::chan $1 | %:echo 15-> -14 $+ %::target $+ 15-14 %::text $+  %:comments }
else { %:echo 15•14• notice sent 15» 14( $+ %::nick $+ )1514 %::text $+  %:comments }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 15[ $+ %::cmode $+ 14 $+ %::nick $+ 15]14 %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on &^*:ACTION:*:#:{
  if ($chan !ischan) { return }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 15• 14 $+ %::nick %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on &^*:NOTICE:*:#:{
  if ($chan !ischan) { return }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 15-14 $+ %::nick $+ : $+ %::target $+ 15-14 %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
if ($query($nick)) { set -u1 %:echo %e $nick | %:echo 15* 14 $+ %::nick %::text $+  %:comments | haltdef }
  else {
    if ($window(Message Window)) { set -u1 %:echo %e $+ d }
    elseif ($_isactive) && (@* !iswm $active) && ($hget(Kte_Events, Active.Queries)) { set -u1 %:echo %e $+ a }
    else { set -u1 %:echo %e $+ s }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 15-14 $+ %::nick 15[14 $+ %::address $+ 15]-14 %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::text
}
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
if (%ch) { %:echo 15[14 $+ %::nick $+ : $+ %::chan %::ctcp $+ 15] 14 $+ %::text $+  %:comments }
else { %:echo 15[14 $+ %::nick %::ctcp $+ 15] 14 $+ %::text $+  %:comments }
...
if ($1 ischan) { set -u1 %::chan $1 | %:echo 15-> [14 $+ %::target %::ctcp $+ 15] 14 $+ %::text $+  %:comments }
else { set -u1 %::nick $1 | %:echo 15-> [14 $+ %::target %::ctcp $+ 15] 14 $+ %::text $+  %:comments }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 15[14 $+ %::nick %::ctcp reply15] 14 $+ %::text $+  %:comments | haltdef
...
set -nu1 %::c1 14 | set -nu1 %::c2 15 | set -nu1 %::c3 07 | set -nu1 %::c4 14
if (* iswm %::text) { set -nu1 %::parentext 14(07 $+ %::text $+ 14) }
%:echo 15-> [14 $+ %::target %::ctcp reply15] 14 $+ %::text $+  %:comments
...
alias -l kte::Echo %:echo 14 $+ %::text $+  %:comments
alias -l kte::EchoTarget %:echo 14 $+ %::text $+  %:comments
alias -l kte::Error %:echo 07³1414error: %::text $+  %:comments
alias -l kte::Raw.303 %:echo 07³14 %::text are online %:comments
alias -l kte::RAW.375 %:echo 07³1414MOTD - %::server $+  %:comments
alias -l kte::RAW.255 %:echo 07³1414I have %::users clients and %::value servers %:comments
alias -l kte::RAW.471 %:echo 07³1414error:  $+ %::chan $+  is full %:comments
alias -l kte::RAW.391 %:echo 07³1414server time: %::text $+  %:comments
alias -l kte::Raw.332 %:echo 07.::14 topic: 07[15 $+ %::text $+ 07]14 %:comments
alias -l kte::RAW.372 %:echo 14 $+ %::text $+  %:comments
alias -l kte::RAW.252 %:echo $+(%::pre,,%::c1,%::value) $iif(%::value == 1,operator,operators) online
alias -l kte::Raw.408 %:echo 07³1414error:  $+ %::chan $+  you cannot use colors on this channel %:comments
...
alias -l kte::RAW.265 %:echo 07³1414Current local users: %::users max: %::value $+  %:comments
alias -l kte::RAW.253 %:echo 07³1414 $+ %::value unknown connections %:comments
alias -l kte::RAW.001 %:echo 14Welcome %::text $+  %:comments
alias -l kte::RAW.482 %:echo 07³1414error:  $+ %::chan $+  you aren't an op %:comments
alias -l kte::RAW.401 %:echo 07³1414error:  $+ %::nick $+  no such nickname %:comments
alias -l kte::RAW.266 %:echo 07³1414Current global users: %::users max: %::value $+  %:comments
alias -l kte::RAW.250 %:echo 07³1414 $+ %::value total connections %:comments
alias -l kte::RAW.002 %:echo 14Your Host Is %::server $+ , running %::value $+  %:comments
alias -l kte::RAW.474 %:echo 07³1414error:  $+ %::chan $+  banned from channel %:comments
alias -l kte::RAW.003 %:echo 14This server was created on %::value $+  %:comments
alias -l kte::Raw.251 %:echo 07³1414There are %::users users online, %::text invisible, on %::value servers %:comments
alias -l kte::RAW.475 %:echo 07³1414error:  $+ %::chan $+  key required %:comments
alias -l kte::RAW.324 %:echo 07.::14 modes: 07[15 $+ %::modes $+ 07]14 %:comments
alias -l kte::RAW.403 %:echo 07³1414error:  $+ %::chan $+  no such channel %:comments
alias -l kte::RAW.376 %:echo 07³1414end of MOTD %:comments
alias -l kte::RAW.221 %:echo 07³1414 usermode: %::modes $+  %:comments
alias -l kte::Raw.301 %:echo 07³14 %::nick is away: %::text $+  %:comments
alias -l kte::RAW.432 %:echo 07³1414error:  $+ %::nick $+  invalid nickname %:comments
alias -l kte::RAW.404 %:echo 07³1414error:  $+ %::chan $+  unable to send message %:comments
alias -l kte::RAW.353 %:echo 07.::14 names 07[15 $+ %::chan $+ 07]:14 %::text $+  %:comments
alias -l kte::RAW.341 %:echo 07³1414 $+ %::nick invited to %::chan $+  %:comments
alias -l kte::RAW.005 %:echo %::text $+  %:comments
alias -l kte::RAW.473 %:echo 07³1414error:  $+ %::chan $+  invite only %:comments
alias -l kte::Raw.302 %:echo 07³1414 userhost %::nick $+ : %::address $+  %:comments
alias -l kte::RAW.433 %:echo 07³1414error:  $+ %::nick $+  is in use %:comments
alias -l kte::RAW.421 %:echo 07³1414error:  $+ %::value $+  invalid command %:comments
alias -l kte::RAW.366 %:echo 07.::14 end of /names %::chan $+  %:comments
