...
alias -l kte::RAW.333 %:echo $+(,%::c3,.::) $+(,%::c1,set by:) $+(,%::c3,$chr(40),,%::c2,%::nick,,%::c3,$chr(41),,%::c1) on $+(,%::c3,$chr(40),,%::c2,$asctime($ctime(%::text),ddd mmm dd $+ $chr(44) yyyy h:nn tt),,%::c3,$chr(41),,%::c1)
alias -l kte::RAW.329 %:echo .:: $+(,%::c1,channel created:) $+(,%::c3,$chr(40),,%::c2,$asctime(%::text,ddd mmm dd $+ $chr(44) yyyy h:nn tt),,%::c3,$chr(41))
