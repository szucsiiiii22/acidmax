VERSION 5.00
Begin VB.UserControl InternetFile 
   ...
   MaskColor       =   &H00FF00FF&
   MaskPicture     =   "InternetFile.ctx":0000
   Picture         =   "InternetFile.ctx":117A
   PropertyPages   =   "InternetFile.ctx":22F4
   ScaleHeight     =   570
   ScaleWidth      =   600
   ToolboxBitmap   =   "InternetFile.ctx":2310
End
Attribute VB_Name = "InternetFile"
...
Attribute LocalFile.VB_ProcData.VB_Invoke_Property = "Download"
...
Attribute Url.VB_ProcData.VB_Invoke_Property = "Download"
  Url = m_Url
End Property
...
Attribute Port.VB_ProcData.VB_Invoke_Property = "Download"
  Port = m_Port
End Property
...
Attribute SiteUser.VB_ProcData.VB_Invoke_Property = "Download"
  SiteUser = m_SiteUser
End Property
...
Attribute SitePassword.VB_ProcData.VB_Invoke_Property = "Download"
...
Attribute ProxyPort.VB_Description = "Port of Proxyserver. Default is 8080"
Attribute ProxyPort.VB_ProcData.VB_Invoke_PropertyPut = "Connection"
...
Attribute ProxyServer.VB_Description = "IP or Domainname of Proxyserver"
Attribute ProxyServer.VB_ProcData.VB_Invoke_Property = "Connection"
...
Attribute ProxyUser.VB_ProcData.VB_Invoke_Property = "Connection"
...
Attribute ProxyPassword.VB_ProcData.VB_Invoke_Property = "Connection"
